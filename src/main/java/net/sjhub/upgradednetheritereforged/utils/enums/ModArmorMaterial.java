...
public enum ModArmorMaterial implements ArmorMaterial {
   GOLD_UPGRADED_NETHERITE("upgradednetherite_reforged:gold_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (goldUpgradedNetherite) -> {
   ...
   FIRE_UPGRADED_NETHERITE("upgradednetherite_reforged:fire_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (fireUpgradedNetherite) -> {
   ...
   ENDER_UPGRADED_NETHERITE("upgradednetherite_reforged:ender_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (enderUpgradedNetherite) -> {
   ...
   WATER_UPGRADED_NETHERITE("upgradednetherite_reforged:water_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (waterUpgradedNetherite) -> {
   ...
   WITHER_UPGRADED_NETHERITE("upgradednetherite_reforged:wither_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (witherUpgradedNetherite) -> {
   ...
   POISON_UPGRADED_NETHERITE("upgradednetherite_reforged:poison_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (poisonUpgradedNetherite) -> {
   ...
   PHANTOM_UPGRADED_NETHERITE("upgradednetherite_reforged:phantom_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (phantomUpgradedNetherite) -> {
   ...
   FEATHER_UPGRADED_NETHERITE("upgradednetherite_reforged:feather_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (featherUpgradedNetherite) -> {
   ...
   CORRUPT_UPGRADED_NETHERITE("upgradednetherite_reforged:corrupt_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (corruptUpgradedNetherite) -> {
   ...
   ECHO_UPGRADED_NETHERITE("upgradednetherite_reforged:echo_upgraded_netherite", 37, (EnumMap)Util.m_137469_(new EnumMap(Type.class), (echoUpgradedNetherite) -> {
   ...
   private static final EnumMap<Type, Integer> MAX_DAMAGE_ARRAY = (EnumMap)Util.m_137469_(new EnumMap(Type.class), (p_266653_) -> {
