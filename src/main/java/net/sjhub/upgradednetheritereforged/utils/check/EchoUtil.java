...
import com.rolfmao.upgradedcore_old.utils.morecheck.MoreEchoUtil;
...
public class EchoUtil {
   ...
   public static boolean isEchoToolOrWeapon(ItemStack itemStack) {
      return ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_PICKAXE.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_SHOVEL.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_AXE.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_HOE.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_BOW.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreEchoUtil.isEchoToolOrWeapon(itemStack);
   }
   ...
   public static boolean isEchoMeleeWeapon(ItemStack itemStack) {
      return ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_AXE.get())) || MoreEchoUtil.isEchoWeapon(itemStack);
   }

   public static boolean isEchoRangedWeapon(ItemStack itemStack) {
      return ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_BOW.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreEchoUtil.isEchoRangedWeapon(itemStack);
   }

   public static boolean isEchoTool(ItemStack itemStack) {
      return ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_PICKAXE.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_SHOVEL.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_AXE.get())) || ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_HOE.get())) || MoreEchoUtil.isEchoTool(itemStack);
   }

   public static boolean isEchoProjectile(Projectile projectile) {
      return (projectile instanceof Arrow || projectile instanceof SpectralArrow || projectile instanceof FireworkRocketEntity || MoreEchoUtil.isEchoProjectile(projectile)) && projectile.getTags().contains("EchoUpgradedNetheriteBow");
   }

   public static boolean isEchoShield(ItemStack itemStack) {
      return ItemStack.isSameItem(itemStack, new ItemStack((ItemLike)ModItems.ECHO_UPGRADED_NETHERITE_SHIELD.get())) || MoreEchoUtil.isEchoShield(itemStack);
   }
