...
public class WitherUtil {
   ...
   public static boolean isHorseWearingWitherArmor(Horse horse) {
      return horse.getArmor().getItem() == ((HorseArmorItem)ModItems.WITHER_UPGRADED_NETHERITE_ARMOR_HORSE.get()).m_5456_() || MoreWitherUtil.isHorseWearingWitherArmor(horse);
   }
   ...
   public static boolean isWitherToolOrWeapon(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_BOW.get())) || ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreWitherUtil.isWitherToolOrWeapon(itemStack);
   }
   ...
   public static boolean isWitherMeleeWeapon(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || MoreWitherUtil.isWitherWeapon(itemStack);
   }

   public static boolean isWitherRangedWeapon(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_BOW.get())) || ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreWitherUtil.isWitherRangedWeapon(itemStack);
   }

   public static boolean isWitherTool(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || MoreWitherUtil.isWitherTool(itemStack);
   }
   ...
   public static boolean isWitherShield(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SHIELD.get())) || MoreWitherUtil.isWitherShield(itemStack);
   }

   public static boolean isWitherHorseArmor(ItemStack itemStack) {
      return ItemStack.isSame(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_ARMOR_HORSE.get())) || MoreWitherUtil.isWitherHorseArmor(itemStack);
   }
}
