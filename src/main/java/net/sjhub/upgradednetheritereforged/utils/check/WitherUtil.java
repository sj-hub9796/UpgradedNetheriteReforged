...
public class WitherUtil {
   ...
   public static boolean isWitherArmor(ItemStack itemStack) {
      return itemStack.m_41720_() instanceof ArmorItem && ((ArmorItem)itemStack.m_41720_()).m_40401_() == ModArmorMaterial.WITHER_UPGRADED_NETHERITE || MoreWitherUtil.isWitherArmor(itemStack);
   }

   public static boolean isWitherToolOrWeapon(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_BOW.get())) || ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreWitherUtil.isWitherToolOrWeapon(itemStack);
   }
   ...
   public static boolean isWitherMeleeWeapon(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SWORD.get())) || ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || MoreWitherUtil.isWitherWeapon(itemStack);
   }

   public static boolean isWitherRangedWeapon(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_BOW.get())) || ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_CROSSBOW.get())) || MoreWitherUtil.isWitherRangedWeapon(itemStack);
   }

   public static boolean isWitherTool(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_AXE.get())) || MoreWitherUtil.isWitherTool(itemStack);
   }
   ...
   public static boolean isWitherShield(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_SHIELD.get())) || MoreWitherUtil.isWitherShield(itemStack);
   }

   public static boolean isWitherHorseArmor(ItemStack itemStack) {
      return ItemStack.m_41746_(itemStack, new ItemStack((ItemLike)ModItems.WITHER_UPGRADED_NETHERITE_ARMOR_HORSE.get())) || MoreWitherUtil.isWitherHorseArmor(itemStack);
   }
}
