...
public class UpgradedNetheriteSword extends SwordItem {
   ...
   public boolean canApplyAtEnchantingTable(ItemStack itemStack, Enchantment enchantment) {
      return itemStack.m_41720_() == ModItems.CORRUPT_UPGRADED_NETHERITE_SWORD.get() && enchantment == Enchantments.f_44962_ ? false : enchantment.f_44672_.m_7454_(itemStack.m_41720_());
   }

   public void m_6883_(ItemStack itemStack, Level level, Entity entity, int slot, boolean p_77663_5_) {
      if (itemStack.m_41720_() == ModItems.CORRUPT_UPGRADED_NETHERITE_SWORD.get() && itemStack.m_41793_() && EnchantmentHelper.getTagEnchantmentLevel(Enchantments.f_44962_, itemStack) > 0) {
   ...
   public InteractionResult m_6225_(UseOnContext context) {
      ...
      if (iResult == InteractionResult.PASS && context.m_43723_() != null && context.m_43723_().m_6047_() && EnderUtil.isEnderMeleeWeapon(context.m_43722_()) && !context.m_43723_().m_36335_().m_41519_(context.m_43722_().m_41720_())) {
