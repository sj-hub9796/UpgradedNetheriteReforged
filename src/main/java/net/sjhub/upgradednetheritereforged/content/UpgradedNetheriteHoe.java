...
public class UpgradedNetheriteHoe extends HoeItem {
   ...
   public boolean canApplyAtEnchantingTable(ItemStack itemStack, Enchantment enchantment) {
      return itemStack.getItem() == ModItems.CORRUPT_UPGRADED_NETHERITE_HOE.get() && enchantment == Enchantments.MENDING ? false : enchantment.category.canEnchant(itemStack.getItem());
   }

   public void inventoryTick(ItemStack itemStack, Level level, Entity entity, int slot, boolean p_77663_5_) {
      if (itemStack.getItem() == ModItems.CORRUPT_UPGRADED_NETHERITE_HOE.get() && itemStack.isEnchanted() && EnchantmentHelper.getTagEnchantmentLevel(Enchantments.MENDING, itemStack) > 0) {
      ...
      if (!UpgradedNetheriteConfig.DisableTooltips) {
         if (Screen.hasShiftDown()) {
            if (GoldUtil.isGoldTool(itemStack) && UpgradedNetheriteConfig.EnableFortuneBonus) {
               ...
               tooltip.add(Component.translatable("upgradednetherite_reforged.Gold_Hoe.TT"));
               ...
               tooltip.add(Component.translatable("upgradednetherite_reforged.Blank.TT"));
               tooltip.add(Component.translatable("upgradednetherite_reforged.Bonus.TT"));
               tooltip.add(Component.translatable("upgradednetherite_reforged.Poison_Hoe.TT"));
